...
UINT32 OV8856_SUB_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
...
#endif
#if defined(OV8856_SUB_MIPI_RAW)
    {OV8856_SUB_SENSOR_ID, SENSOR_DRVNAME_OV8856_SUB_MIPI_RAW, OV8856_SUB_MIPI_RAW_SensorInit},
#endif
