...
//
#ifdef CONFIG_CUSTOM_M7
extern unsigned int g_vcom0_int;
extern unsigned int g_vcom1_int;
extern unsigned int g_vcom2_int;
#endif
//
...
#ifdef CONFIG_CUSTOM_M7
			{
				char *p_vcom0,*p_vcom1,*p_vcom2;
				//
				printk("@@yangcl %s \n",saved_command_line);
				p_vcom0=strstr(saved_command_line, "vcom0=");
				if (p_vcom0 != NULL)
				{
					p_vcom0+= strlen("vcom0=");
			    		g_vcom0_int = simple_strtol(p_vcom0, NULL, 10); 
				}
				//
				p_vcom1=strstr(saved_command_line, "vcom1=");
				if (p_vcom1 != NULL)
				{
					p_vcom1+= strlen("vcom1=");
			    		g_vcom1_int = simple_strtol(p_vcom1, NULL, 10); 
				}
				//
				p_vcom2=strstr(saved_command_line, "vcom2=");
				if (p_vcom2 != NULL)
				{
					p_vcom2+= strlen("vcom2=");
			    		g_vcom2_int = simple_strtol(p_vcom2, NULL, 10); 
				}
				//
				printk("@@yangcl g_vcom0_int =0x%x,g_vcom1_int =0x%x,g_vcom2_int =0x%x \n",g_vcom0_int,g_vcom1_int,g_vcom2_int);
			}
#endif
#if 0			
